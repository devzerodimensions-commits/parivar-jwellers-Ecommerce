        ...
        {banners.map((b) => (
          ...
          >
            <img
              src={b.image}
              alt={b.title || 'Banner'}
              className="aspect-[1904/570] w-full object-cover"
            />
            {/* Text overlay only when the banner actually has text — so a fully
                designed banner image (e.g. 1904x570) shows clean and un-obscured. */}
